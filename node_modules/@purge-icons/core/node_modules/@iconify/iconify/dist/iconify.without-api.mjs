...
export { addCollection, addIcon, buildIcon, calculateSize, Iconify as default, getIcon, getVersion, iconExists, listIcons, observe, pauseObserver, renderHTML, renderIcon, renderSVG, replaceIDs, resumeObserver, scan, shareStorage, stopObserving };
