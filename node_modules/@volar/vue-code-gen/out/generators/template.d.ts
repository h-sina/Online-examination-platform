...
export declare function generate(sourceLang: string, templateAst: CompilerDOM.RootNode, isVue2: boolean, cssScopedClasses: string[] | undefined, htmlToTemplate: (htmlStart: number, htmlEnd: number) => {
    start: number;
    end: number;
