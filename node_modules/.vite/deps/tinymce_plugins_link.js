  ...
  "node_modules/tinymce/plugins/link/plugin.js"() {
    ...
    (function() {
      ...
      var getDelta = function(persistentText, fieldName, catalog, data) {
        ...
        return value !== void 0 ? findTextByValue(value, catalog).map(function(i) {
          return {
            url: {
              value: i.value,
              meta: {
      ...
      var setupGotoLinks = function(editor) {
        editor.on("click", function(e) {
          var link2 = getLink(editor, e.target);
          if (link2 && global$6.metaKeyPressed(e)) {
            e.preventDefault();
        ...
        editor.on("keydown", function(e) {
          ...
          if (link2 && e.keyCode === 13 && hasOnlyAltModifier(e)) {
            e.preventDefault();
            gotoLink(editor, link2);
          }
        });
