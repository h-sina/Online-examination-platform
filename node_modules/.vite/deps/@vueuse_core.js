...
function useFileSystemAccess(options = {}) {
  ...
  function open() {
    return __async(this, arguments, function* (_options = {}) {
      if (!isSupported)
        return;
      const [handle] = yield window2.showOpenFilePicker(__spreadValues$82(__spreadValues$82({}, unref(options)), _options));
  ...
  function create() {
    return __async(this, arguments, function* (_options = {}) {
      if (!isSupported)
        return;
      fileHandle.value = yield window2.showSaveFilePicker(__spreadValues$82(__spreadValues$82({}, unref(options)), _options));
      data.value = void 0;
      yield updateFile();
      yield updateData();
    });
