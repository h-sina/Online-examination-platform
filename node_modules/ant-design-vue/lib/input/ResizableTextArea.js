...
var ResizableTextArea = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var renderTextArea = function renderTextArea() {
      ...
      var otherProps = (0, _omit.default)(props, ['prefixCls', 'onPressEnter', 'autoSize', 'autosize', 'defaultValue', 'allowClear', 'type', 'lazy', 'maxlength']);
      var cls = (0, _classNames2.default)(prefixCls, attrs.class, (0, _defineProperty2.default)({}, "".concat(prefixCls, "-disabled"), disabled));
      var style = (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, attrs.style), textareaStyles.value), resizeStatus.value === RESIZE_STATUS_RESIZING ? {
        overflowX: 'hidden',
        overflowY: 'hidden'
      } : null);
