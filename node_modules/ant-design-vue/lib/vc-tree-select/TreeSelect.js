...
var _default = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var displayValues = (0, _vue.computed)(function () {
      ...
      var displayKeys = (0, _strategyUtil.formatStrategyValues)(rawCheckedValues.value, props.showCheckedStrategy, keyEntities.value, mergedFieldNames.value); // Convert to value and filled with label
    ...
    return function () {
      ...
      var restProps = (0, _omit.default)(props, ['id', 'prefixCls', // Value
