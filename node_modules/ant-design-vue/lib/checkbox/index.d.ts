...
declare const _default: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "type" | "checked" | "autofocus" | "defaultChecked" | "indeterminate" | "isGroup" | "skipGroup">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
