...
import type { InternalNamePath, NamePath, ValidateErrorEntity, ValidateOptions, ValidateMessages, Rule } from './interface';
...
declare const _default: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "colon" | "requiredMark" | "labelWrap" | "hideRequiredMark" | "model" | "validateMessages" | "validateOnRuleChange">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
